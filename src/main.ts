...
const experienceListComponent = document.querySelector('.experience-list')

projectsListComponent!.innerHTML = projects.map(project => `
  <div class="project-item">
    ...
    <div class="project-info">
      <div class="project-heading">
        <h3>
          ${project.title} 
          ${project.comercial ? `<span class="comercial">Коммерческий</span>` : ""} 
        </h3>
        <div class="links">
  ...
  experienceListComponent!.innerHTML = experiences.map(experience => `
            <div class="experience-item">
              ...
              <div class="experience-info">
                ...
                <ul class="langs-list">
                  ${experience.langs.map(lang => `<li class="lang-item">${lang}</li>`).join('')}
                </ul>
              </div>
  </div>`).join('')
