(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function c(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(e){if(e.ep)return;e.ep=!0;const t=c(e);fetch(e.href,t)}})();const p=[{title:"CoLimg",description:"Сюда можно загрузить картинку и получить акцентные цвета.",image:"./assets/projects/colimg.png",link:"https://example.com/project1",github:"https://example.com/project1",langs:["HTML","CSS","TypeScript","SCSS","Webpack"]},{title:"Магазин цветов",description:"Интернет-магазин встроенный в Telegram.",image:"./assets/projects/dff.png",link:"https://example.com/project1",github:"https://example.com/project1",langs:["React","Redux","JavaScript","SCSS","Create React App"]},{title:"Манамайнер",description:"Игра по накоплению маны.",image:"./assets/projects/manamainer.png",link:"https://example.com/project1",github:"https://example.com/project1",langs:["React","Redux","TypeScript","SCSS","Vite"]},{title:"RegExp Constructor",description:"Конструктор RegExp выражений.",image:"./assets/projects/reg.png",link:"https://example.com/project1",github:"https://example.com/project1",langs:["React","Redux","TypeScript","SCSS","Create React App"]},{title:"FastLogo",description:"Здесь можно сгенерировать ультра-уникальный логотип.",image:"./assets/projects/fast-logo.png",link:"https://example.com/project1",github:"https://example.com/project1",langs:["React","TypeScript","SCSS","Vite"]},{title:"Loader&Charts",description:"Это было тестовое задание из Хабр.Карьера.",image:"./assets/projects/loaders.png",link:"https://example.com/project1",github:"https://example.com/project1",langs:["Vue","TypeScript","SCSS","Vite"]}],a=document.querySelector(".projects-list");a.innerHTML=p.map(s=>`
          <div class="project-item">
            ...
            <div class="project-info">
              ...
              <p>${s.description}</p>
              <ul class="langs-list">
                ${s.langs.map(i=>`<li class="lang-item">${i}</li>`).join("")}
              </ul>
            </div>
          </div>`).join("");
